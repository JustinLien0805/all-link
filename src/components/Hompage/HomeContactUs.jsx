...
const HomeContactUs = () => {
  ...
  return (
    <motion.div
      className="flex w-full h-[30rem] px-36 mt-20 mb-40 relative text-black"
      ref={ref}
      variants={variant}
      initial="hidden"
      animate={control}
    >
      {/* watermark */}
      <h2 className="absolute -right-20 top-0 text-[18rem] font-bold opacity-30 text-neutral-400">
        Contact Us
      </h2>
      <div className="flex flex-col justify-end items-end w-full h-full space-y-8 z-10 ml-auto">
        ...
        <div className="text-2xl border-r-4 pr-4 border-teal-500 flex flex-col text-right">
