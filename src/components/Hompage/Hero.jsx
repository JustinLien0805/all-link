...
const Hero = () => {
  ...
  return (
    <div className="flex lg:flex-row justify-center items-center flex-col lg:px-36 md:px-16 md:pt-20 pt-36 z-10">
      ...
      <video src={demo} className="lg:w-[36rem] sm:w-[28rem] w-[20rem] z-50" controls/>
    </div>
  );
};
