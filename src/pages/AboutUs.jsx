    ...
    <div className="w-screen flex flex-col">
      <div className="flex w-full h-full py-20 px-36 mt-20 relative text-black bg-white">
        ...
        <div className="flex flex-col justify-start items-start w-full h-full  space-y-8 z-10">
          <h2 className="text-5xl font-bold border-l-4 pl-4 border-teal-500">關於我們</h2>
          <div className="text-xl opacity-80">
            ...
            <p>
              由於掌握管理、研發、
              製造、營銷、工業產品現場實務經驗 ，深刻了解個人、企業無法切入 IOT
              物聯網的痛點， 歐林克期許要為此投入一份心力歐林克 科技研發多年 ，
              推出了IOT裝置取名物聯通
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              照度、電壓、電流.... 各種的物理數據 ， 都能轉換成動態管理
              曲線 ， 實時展現在您的眼前
            </p>
            <br />
            <p>
              物聯通同時也可將數據存在雲端服務器及記憶卡上最快每
              5秒取樣一次 ， 可將歷史數據轉換為趨勢圖隨時查詢
            </p>
            <br />
            <p>
